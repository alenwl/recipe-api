...
class PrivateRecipeApiTest(TestCase):
    """Test unathenticated API access"""
...
class RecipeImageUploadTests(TestCase):
    ...
    def tearDown(self):
        """The opposite of setUp, it runs after the tests"""
    ...
    def test_upload_invalid_image_recipe(self):
    ...
    def test_filter_recipe_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Vegetables with tahini')
